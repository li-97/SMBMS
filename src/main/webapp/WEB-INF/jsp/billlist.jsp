...
<div class="right">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billpageinfo.list }" varStatus="status">
				<tr>
					<td>
	...
	<input type="hidden" id="totalPageCount" value="${billpageinfo.total}"/>
	<c:import url="/WEB-INF/jsp/rollpage.jsp">
		<c:param name="totalCount" value="${billpageinfo.total}"/>
		<c:param name="currentPageNo" value="${billpageinfo.pageNum}"/>
		<c:param name="totalPageCount" value="${billpageinfo.pages}"/>
	</c:import>
  </div>
</section>
