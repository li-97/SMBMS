...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/list">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/pro/prosDeatils">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/list">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/modpwd">密码修改</a></li>
